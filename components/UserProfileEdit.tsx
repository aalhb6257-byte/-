...
const UserProfileEdit: React.FC<UserProfileEditProps> = ({ profile, onSave, isReadOnly }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in pb-20">
      <div className="mb-8">
        <h2 className="text-3xl font-black text-black dark:text-white">إعدادات ملفي الشخصي</h2>
        ...
        <div className="bg-white rounded-[3rem] shadow-sm border border-slate-100 overflow-hidden">
          <div className="h-40 bg-indigo-600 relative">
            <div className="absolute -bottom-16 right-12 flex items-end gap-6">
              ...
              <div className="mb-4">
                <h3 className="text-2xl font-black text-black dark:text-white">{formData.name}</h3>
          ...
          <div className="px-12 pt-24 pb-12">
            ...
            <div className="pt-10 border-t border-slate-50">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h4 className="text-sm font-black text-black dark:text-white">تخصيص هوية النظام</h4>
